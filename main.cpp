...
*			getDiameter. Returns the diameter of the circle, which is calculated
*								 as diameter = radius * 2
*			getCircumference. Returns the circumference of the circle, which is
*			calculated as circumference = 2 * pi * radius
*	Write a program that demonstrates the Circle class by asking the user for
*	the circle’s radius, creating a Circle object, and then reporting the
